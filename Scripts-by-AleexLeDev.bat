...
set "t[6]=---:REPARATION ET NETTOYAGE"
set "t[7]=sys_rescue_menu:Outil Reparation Windows (Rescue)~Menu multi-outils (SFC, DISM, CHKDSK, Reset WinUpdate...)"
set "t[8]=sys_cleanmgr:Nettoyage de disque~Lancement classique de l'utilitaire de nettoyage"
set "t[9]=sys_registry_cleanup:Nettoyage du Registre~Optimisation rapide et suppression des entrees mortes"
set "t[10]=sys_tweaks_menu:Menu Optimisation Windows 11~Bloatwares, Telemetrie, Performances, Cortana"
set "t[11]=sys_repair_icons:Reparation Cache Icones~Corrige les icones/miniatures corrompues"
set "t[12]=---:RESEAU ET DNS"
set "t[13]=dns_manager:Gestionnaire DNS~Changer DNS Cloudflare/Google"
set "t[14]=sys_network_menu:Menu de Depannage Reseau~Outils avances (DNS, ARP, TCP/IP, Autoreset)"
set "t[15]=---:MISES A JOUR ET APPLICATIONS"
set "t[16]=winget_manager:Mises a jour d'applications~Mettre a jour vos logiciels via Winget"
set "t[17]=app_installer:Installateur d'applications~Installer des logiciels par categorie via Winget"
set "t[18]=---:MOT DE PASSE ET SECURITE"
set "t[19]=sys_passwords_menu:Extracteurs de mots de passe~Outils Powershell (Credentials, Wi-Fi, Nirsoft)"
set "t[20]=sys_unlock_notes:Recuperation de Compte bloque~Instructions pour reprendre controle sans mot de passe"
set "t[21]=um_menu:Gestion utilisateurs locaux~Panneau de gestion local (Admin, Pass, Ajouts)"
set "t[22]=---:OUTILS ET EXTRACTION"
set "t[23]=sys_win_key:Cle de licence~Recuperer vos differentes cles de produit"
set "t[24]=sys_drivers:Extraction des pilotes~Sauvegarde de tous les fichiers pilotes natifs"
set "t[25]=disk_manager:Formatteur de Disque (DISKPART)~Formater un disque de facon securisee"
set "t[26]=touch_screen_manager:Gestionnaire Ecran Tactile~Activation et desactivation du pilote tactile"
set "t[27]=context_menu:Menu contextuel Windows 11~Classic/Modern"
