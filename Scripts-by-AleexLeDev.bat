...
set "t[14]=---:SYSTEME ET DIAGNOSTIC"
set "t[15]=sys_report:Diagnostic Systeme Complet~Affiche les specifications et l'etat de sante global"
set "t[16]=sys_repair_icons:Reparation Cache Icones~Corrige les icones/miniatures corrompues"
set "t[17]=sys_win_key:Cle de licence~Recuperer vos differentes cles de produit"
set "t[18]=---:APPLICATIONS"
set "t[19]=winget_manager:Mises a jour d'applications~Mettre a jour vos logiciels via Winget"
set "t[20]=---:PERSONNALISATION"
set "t[21]=context_menu:Menu contextuel Windows 11~Classic/Modern"
set "t[22]=sys_god_mode:Dossier God Mode~Creer le raccourci ultime des parametres"
set "t[23]=---:GESTION DES UTILISATEURS"
set "t[24]=um_menu:Gestion utilisateurs locaux~Panneau de gestion local (Admin, Pass, Ajouts)"
set "t[25]=---:PILOTES"
set "t[26]=sys_drivers:Extraction des pilotes~Sauvegarde de tous les fichiers pilotes natifs"
set "t[27]=---:MOT DE PASSE"
...
set "t[32]=sys_battery_report:Rapport de Batterie~Usure, Sante et stats en temps reel"
set "t[33]=---:INSTALLATION D'APPLICATIONS"
set "t[34]=app_installer:Installateur d'applications~Installer des logiciels par categorie via Winget"
:: Sous-items pour gestion des favoris individuels
set "t[35]=dump_credman:Gestionnaire d'identifiants (Windows)~Extrait le Credential Manager Windows (WCMDump):HIDDEN"
set "t[36]=dump_wifi:Extraction reseaux Wi-Fi (Powershell)~Script WWP puissant listant psw et noms:HIDDEN"
set "t[37]=sys_nirsoft_pw:WebBrowserPassView (Classique Nirsoft)~Ancien utilitaire graphique pour les mots de passe:HIDDEN"
set "t[38]=res_sfc:Scan RAPIDE du systeme~SFC /scannow (Verification systeme rapide):HIDDEN"
set "t[39]=res_dism_check:Verification image base~DISM /CheckHealth et /ScanHealth (Analyse image):HIDDEN"
set "t[40]=res_dism_restore:Reparation profonde~DISM /RestoreHealth (Reparation fichiers systeme):HIDDEN"
set "t[41]=res_temp_clean:Nettoyage massif (Temp/Cache)~Purge des fichiers temporaires et cache Windows Update:HIDDEN"
set "t[42]=res_chkdsk:Planifier un CHKDSK (C:)~Verification disque au prochain demarrage (CHKDSK /F /R):HIDDEN"
set "t[43]=res_wu_reset:Reset Fix Windows Update~Reinitialisation forcee des composants Windows Update:HIDDEN"
set "total_tools=43"
