...
if "%sys_choice%"=="4" goto sys_dns_options
if "%sys_choice%"=="5" goto sys_ipconfig
if "%sys_choice%"=="6" goto sys_restart_network
if "%sys_choice%"=="7" goto sys_repair_network
if "%sys_choice%"=="8" goto sys_cleanmgr
if "%sys_choice%"=="9" goto sys_chkdsk
if "%sys_choice%"=="10" goto sys_temp_cleanup
if "%sys_choice%"=="11" goto sys_registry_cleanup
if "%sys_choice%"=="12" goto sys_drivers
if "%sys_choice%"=="13" goto sys_windows_update
